...
export async function init(DOMRefs) {
    ...
    // 4. Peupler les tables avec les données pré-chargées
    ...
    populateTable(scenario1TableBody, ScenariosData[1], DOMRefs);
    populateTable(scenario2TableBody, ScenariosData[2], DOMRefs);
...
function handleScenarioButtonClick(e, DOMRefs) {
    ...
    const data = ScenariosData[id]; // Utilise les données pré-chargées
...
function handleDrawScenario(DOMRefs) {
    ...
    const data = ScenariosData[randomScenarioId]; // Utilise les données pré-chargées
